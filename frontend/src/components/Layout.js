...
export default function Layout({ children }) {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-purple-50 via-orange-50 to-yellow-50">
      {/* Top Bar */}
      <div className="glass sticky top-0 z-40 px-3 sm:px-4 py-3 shadow-sm w-full overflow-x-hidden overflow-y-visible">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-2 sm:gap-4 w-full relative">
          {/* Logo */}
          ...
          {/* Actions */}
          <div className="flex items-center gap-2 relative" style={{ zIndex: 50 }}>
            <Button
              variant="ghost"
              size="icon"
